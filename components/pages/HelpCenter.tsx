...
export const HelpCenter: React.FC<HelpCenterProps> = ({ setPage }) => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Lighthouse focuses heavily on performance metrics (Time to Interactive, LCP). Webai Auditor focuses on 'human-first logic'—UX feel, visual hierarchy, and code best practices that affect maintainability and user trust."
    }
  ];
