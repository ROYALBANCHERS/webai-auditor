...
const loadingMessages = [
  "Opening the website in a real browser...",
  "Scanning buttons, links, and navigation...",
  "Checking mobile and responsive behavior...",
  "Analyzing SEO and metadata...",
  "Collecting console and functionality issues...",
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20">
      ...
      <p className="text-gray-400 text-sm mt-6 italic">
        "Please wait while we complete a real-user style audit."
      </p>
    </div>
  );
};
